...
export default function InstructionPanel({ isOpen, onClose }: InstructionPanelProps) {
  ...
  return (
    <div
      className={`fixed top-[5vh] right-0 max-h-[80vh] w-64 bg-white dark:bg-gray-800 p-4 shadow-lg transform ${
    ...
    >
      ...
      <h2 className="text-bitronics text-xl font-bold mb-4">{t('instructions.title')}</h2>
